...
function php() {
  return src(['src/blocks/modules/common/*/*.php', 'src/blocks/modules/pages/**/*.php'])
  .pipe(dest('dist/php'))
  .pipe(browserSync.stream());
}
...
function watch() {
  ...
  gulp.watch(['src/blocks/modules/common/*/*.php', 'src/blocks/modules/pages/**/*.php'], gulp.parallel(php));
...
exports.build = gulp.series(clean, clear,
    gulp.parallel([html, php, style, script, images, webP, spriteSvg, fonts, favicon, gzip]),
